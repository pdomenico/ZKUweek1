...
template sudoku() {
    ...
    component rangePuzzle[81];
    component rangeSolution[81];
    ...
    for (var i=0; i<9; i++) {
        for (var j=0; j<9; j++) {
            ...
            rangePuzzle[i*9 + j] = RangeProof(32);
            rangePuzzle[i*9 + j].range[0] <== 0;
            rangePuzzle[i*9 + j].range[1] <== 9;
            rangePuzzle[i*9 + j].in <== puzzle[i][j];
            assert(rangePuzzle[i*9 + j].out == 1);
            ...
            rangeSolution[i*9 + j] = RangeProof(32);
            rangeSolution[i*9 + j].range[0] <== 0;
            rangeSolution[i*9 + j].range[1] <== 9;
            rangeSolution[i*9 + j].in <== solution[i][j];
            assert(rangeSolution[i*9 + j].out == 1);
